    ...
    <section class="banner_area">
        <div class="container">
            <div class="banner_inner_text">
                <h2>الدبلوم العالي للمديرات</h2>
                <p>يستهدف مديرات الدور النسائية و المساعدات</p>
            </div>
        </div>
    </section>
    <!--================End Banner Area =================-->
                ...
                <div class="col-lg-9">
                    <div class="blog_main_inner">
                        <div class="blog_main_item">
                            ...
                            <div class="blog_text">
                                <a href="#">
                                    <h4>مدة الدبلوم العالي للمديرات : عام دراسي </h4>
                                </a>
                            ...
                            <p>
                                يتضمن علوم إدارية وتربوية شرعية((وثيقة مقدمة من مركز معاهد

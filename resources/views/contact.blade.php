...
<body>
    ...
    <section class="get_in_touch_area p_100">
        ...
        <div class="touch_details">
            <div class="l_title">
                ...
                <h2>التواصل على الايميل</h2>
            </div>
            <p>alburhan1435@gmail.com</p>
            <a>
                <h5>هاتف رقم</h5>
            </a>
            <a>
    ...
    <section class="contact_map_area">
        <div id="mapBox1" class="mapBox1 row m0" data-lat="24.7629826" data-lon="46.6666754" data-zoom="15"
            data-marker="" data-info="" data-mlat="" data-mlon="" <div class="map_location_box">

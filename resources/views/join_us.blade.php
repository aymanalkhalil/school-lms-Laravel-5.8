                            ...
                            <div class="blog_text">
                                <form action="{{ route('upload_cv') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" dir="rtl" class="form-control" id="">
                                    </div>
                                    <div class="form-group">
                                        <a href="{{ asset('cv_files/استمارة طلب وظيفة.pdf') }}"
                                            class="btn btn-info form-control" target="_blank"><i
                                                class="fa fa-download"></i>تحميل
                                            استمارة طلب الوظيفة</a>
                                    </div>
                                    <div class="form-group text-center">
                                        <strong>
                                            <span dir="rtl" class="text-danger">يرجى تحميل هذه الاستمارة وتعبئتها
                                                وارفاقها
                                                بصيغة
                                                PDF</span>
                                        </strong>
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="file" dir="rtl" class="form-control" name="cv">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="form-control btn-outline-success">ارفاق
                                            الاستمارة</button>
                                    </div>

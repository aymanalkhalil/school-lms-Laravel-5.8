        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" method="POST" action="">
                    ...
                    <span class="section">مشاهدة سؤال الاختبار </span>
                    @if ($id->type==1)
                    <div id="block_multiple">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="question_mul" readonly value="{{ $id->question }}"
                        ...
                        $i=1;
                        @endphp
                        @foreach ($id->choice as $item)

                        <div class="item form-group">
                            <label class="control-label col-md-1 col-sm-3 col-xs-12" for=""> الاجابة{{ $i }}
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="answer_mul[]" readonly value="{{$item->choice }}"
                                    class="form-control has-feedback-left">
                            </div>
                        </div>
                        @php
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="correct_answer_mul" readonly value="{{ $id->answer }}"
                                    class="form-control has-feedback-left">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" min="1" readonly value="{{ $id->mark }}" name="mark_mul"
                    ...
                    <div id="block_true">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ $id->question }}" readonly name="question_true"
                                    class="form-control has-feedback-left">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="correct_answer_true" readonly required class="form-control">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" min="1" readonly value="{{ $id->mark }}" name="mark_true"
                                    class="mark form-control has-feedback-left">
                            </div>
                        </div>

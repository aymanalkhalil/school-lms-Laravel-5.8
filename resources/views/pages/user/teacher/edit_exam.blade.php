                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="date" class="form-control has-feedback-left" value="{{ $id->exam_date }}"
                                    name="exam_date">
...
@section('script')
    <script>
        ...
        $(function() {
            ...
            var diff_sec = (new Date("1970-1-1 " + exam_close) - new Date("1970-1-1 " + exam_open)) / 1000;

...
<div class="row">
   <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
         ...
         <div class="x_content">
            <form class="form-horizontal form-label-left"  method="POST" action="/add_moderators">
               @csrf
               ...
               <div class="form-group row">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">اعد كتابة كلمة المرور <span
                     class="required">مطلوب</span>
                  </label>
                  <div class="col-md-6">
               ...
               <table class="table table-striped">
                  ...
                  ?>
                     <tr>
                        ...
                        <th><input type="checkbox" value="enable" name="{{ $item }}"></th>                            
                        @endforeach
                     </tr>
                     <tr>
                        <th>المعلمات</th>

...
<div class="row">
   <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
         ...
         <div class="x_content">
            <form class="form-horizontal form-label-left"  method="POST" action="/update/{{ $id->id }}/moderator">
               @csrf
               @method('put')
               <p>الرجاء  التأكد من ادخال البيانات بالشكل الصحيح</p>
               <span class="section">معلومات المشرفه</span>
               ...
               <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">البريد الالكرتوني
               ...
               <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <select name="years" class="form-control">
                        <option></option>
                     <?php $years = array('ابتدائي','متوسط','دبلوم','بكالوريس','ماجستير','دكتوراه','ثانوي' );?>

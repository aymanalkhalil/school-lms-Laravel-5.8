...
@section('content')
    ...
    <div class="row">
        <span class="section text-center">جميع الموظفين</span>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle"> اضافة الراتب للمشرفة
                                            ...
                                            <form action="{{ route('save_salaries') }}" method="post">
                                                @csrf
    ...
    <div class="row">
        <span class="section text-center">بيانات الرواتب </span>
                    ...
                    @foreach ($all_salaries as $salaries)
                        @if ($salaries->user->role >= 3)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit_salary_mod', $salaries->id) }}" class="btn btn-primary"><i
                                            class="fas fa-user-edit"></i>
                                        تعديل</a>
                                    <a href="{{ route('delete_salary_mod', $salaries->id) }}" class="btn btn-danger"

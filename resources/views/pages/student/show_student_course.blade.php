        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left">
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sana_drasia">الدورة <span
                                class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            @foreach($id->courses as $value)
                            <input type="text" value="{{ $value->name }}" name="sana_drasia" required="required"
                                data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" readonly>
                            @endforeach
                        </div>
                    </div>
                    <div class="item form-group">

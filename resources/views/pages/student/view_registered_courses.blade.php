            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if(!empty($student->bill))
                        <a target="_blank" href="{{ asset('images/bills/'.$student->bill)}}" class='btn btn-success'><i
                                class="fa fa-download"></i> تحميل وصل الدفع</a>
                        @else
                        <label class='btn btn-danger'>الطالبة لم تسدد
                            بعد</label>
                        @endif
                    </td>
                </tr>

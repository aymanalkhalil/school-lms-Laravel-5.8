        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" method="POST"
                    action="/update/course/{{ $id->id }}/student">
                    ...
                    $get_registered_courses= App\UserCourse::where('user_id',$id->id)->first();
                    // dd($get_registered_courses)
                    @endphp
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> الدورة<span class="required"> مطلوب
                            </span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="sana_drsia" class="form-control">
                                ...
                                <option value="{{ $sana_drsia->id }}" @if ($sana_drsia->id ==
                                    $get_registered_courses->course_id) selected

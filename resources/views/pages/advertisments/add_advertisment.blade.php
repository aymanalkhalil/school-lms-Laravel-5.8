    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="{{ route('save_adv') }}">
                        @csrf
                        <p>الرجاء التأكد من ادخال البيانات بالشكل الصحيح</p>
                        <span class="section">اضافة اعلانات البرامج </span>
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">اسم البرنامج <span
                                    class="required">مطلوب</span></label>

                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="programme_id" @if (count($programs) == 0) {{ 'disabled' }} @endif class="form-control">
                                    <option value="" disabled selected>الرجاء اختيار اسم البرنامج</option>
                                    @if (count($programs) > 0)
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" autocomplete="off" id="email" name="target_audience"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="date" id="email" name="date" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" autocomplete="off" id="telephone" name="course_period"
                                    class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="time" id="telephone" name="from" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="time" id="telephone" name="to" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="item form-group">

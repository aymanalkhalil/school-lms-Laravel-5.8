                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown submenu">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li class="nav-item"><a class="nav-link" href="../diploma_a">دبلوم الاشراف التربوي</a>
                            </li>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($get_all_adv as $item)
                                            <tr>
                                                ...
                                                <td>{{ date('h:i A', strtotime($item->from)) . ' ' . date('h:i A', strtotime($item->to)) }}
                                                </td>
                                                <td>{{ $item->teacher }}
                                                </td>
                                                <td>{{ $item->price }}
